...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Use the credentials stored with the user, fallback to env vars
        const clientId = userData.clientId || process.env.GOOGLE_CLIENT_ID;
        const clientSecret = userData.clientSecret || process.env.GOOGLE_CLIENT_SECRET;
